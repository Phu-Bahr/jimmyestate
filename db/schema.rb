...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 2020_09_04_152305) do
=======
ActiveRecord::Schema.define(version: 2020_09_17_185253) do
>>>>>>> 410c542ced0d96c95de587242255537471200093
  ...
  create_table "card_drafts", force: :cascade do |t|
    t.string "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "testimonial_edits", force: :cascade do |t|
    t.string "bannerImage"
    t.string "headerText1"
    t.string "headerText2"
    t.datetime "created_at", null: false
